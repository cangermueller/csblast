...
TEST(ProfileTest, ConstructionFromInputStream)
{
    ...
    data.append("ncols\t6\n");
    data.append("ndim\t14\n");
    data.append(" \tA\tC\tG\tT\tR\tY\tS\tW\tK\tM\tB\tD\tH\tV\n");
    data.append("1\t0\t*\t*\t*\t0\t*\t*\t*\t0\t*\t*\t*\t0\t*\n");
    data.append("2\t*\t0\t*\t*\t0\t*\t*\t*\t0\t*\t*\t*\t0\t*\n");
    data.append("3\t*\t*\t0\t*\t0\t*\t*\t*\t0\t*\t*\t*\t0\t*\n");
    data.append("4\t*\t*\t*\t0\t0\t*\t*\t*\t0\t*\t*\t*\t0\t*\n");
    data.append("5\t0\t*\t*\t*\t0\t*\t*\t*\t0\t*\t*\t*\t0\t*\n");
    data.append("6\t*\t0\t*\t*\t0\t*\t*\t*\t0\t*\t*\t*\t0\t*\n");
...
TEST(ProfileTest, ConstructionOfMultipleProfilesFromInputStream)
{
    ...
    EXPECT_EQ(14, (*profiles[0]).ndim());
    EXPECT_EQ(6, (*profiles[1]).ncols());
    EXPECT_EQ(14, (*profiles[1]).ndim());
